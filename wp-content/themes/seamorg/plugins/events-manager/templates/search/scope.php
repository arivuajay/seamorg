...
$def_scope  = (empty($args['scope'][0])) ? "future" : esc_attr($args['scope'][0]);
?>
<!-- START Date Search -->
<div class="em-search-scope em-search-field ">
    <div class=" em-search-scope em-events-search-dates em-date-range ">
                ...
                <!--<input type="text" class="em-date-input" name="scope[0]" value="<?php // echo $def_scope; ?>" />-->
                <input type="hidden" name="scope[0]" value="<?php echo $def_scope; ?>" />
