            ...
            <div class="row em-location-data-select">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    ...
                    <span class="help-block">
                        <a href="<?php echo get_permalink(250) . "?action=edit"; ?>" target="_blank" data-toggle="tooltip" data-placement="right" title="Guide can suggest hike & admin will approve the hike">
                            Suggest Hike <i class="fa fa-question-circle"></i>
                        </a>
                    </span>
                </div>
