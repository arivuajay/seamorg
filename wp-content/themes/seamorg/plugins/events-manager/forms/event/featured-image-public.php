...
<label for='event_image'> <span class="help-block"> <?php _e('Upload/change picture', 'dbem') ?> </span></label> <input id='event-image' name='event_image' id='event_image' type='file' size='40' />
<br />
<?php if ($EM_Event->get_image_url() != '') : ?>
