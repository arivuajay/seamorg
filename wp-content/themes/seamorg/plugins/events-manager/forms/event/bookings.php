...
?>
<div id="event-rsvp-box" class="hidden">
...
<?php if (!get_option('dbem_bookings_tickets_single') || count($EM_Ticket->get_event()->get_tickets()->tickets) > 1): ?>
    ...
    <?php _e('at', 'dbem'); ?>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <span class="help-block"><?php esc_html_e('This is the definite date after which bookings will be closed for this event, regardless of individual ticket settings above. Default value will be the event start date.', 'dbem'); ?></span>
                </div>
            </div>
            </p>
    <?php endif; ?>
