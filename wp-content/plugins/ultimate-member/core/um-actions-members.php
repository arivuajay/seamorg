			...
			<div class="um-members">
				...
				<div class="um-member <?php echo um_user('account_status'); ?> <?php if ($cover_photos) { echo 'with-cover'; } ?>">
					...
					<?php if ($profile_photo) {
						...
						?>
					<div class="um-member-photo radius-<?php echo $corner; ?>"><a href="<?php echo um_get_core_page('account'); ?>" title="<?php echo um_user('display_name'); ?>"><?php echo get_avatar( um_user('ID'), $default_size ); ?></a></div>
					<?php } ?>

					<div class="um-member-card <?php if (!$profile_photo) { echo 'no-photo'; } ?>">

						<?php if ( $show_name ) { ?>
						<div class="um-member-name"><a href="<?php echo um_get_core_page('account'); ?>" title="<?php echo um_user('display_name'); ?>"><?php echo um_user('display_name'); ?></a></div>
						<?php } ?>
