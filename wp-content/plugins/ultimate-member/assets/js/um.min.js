...
if(c.hasClass("current")){b.next(".um-account-tab").slideUp();c.removeClass("current")}else{b.next(".um-account-tab").slideDown();c.parents("div").find("a").removeClass("current");c.addClass("current")}jQuery(".um-account-side li a:not(.tablink)").removeClass("current");jQuery(".um-account-side li a[data-tab="+a+"]:not(.tablink)").addClass("current");return false})});