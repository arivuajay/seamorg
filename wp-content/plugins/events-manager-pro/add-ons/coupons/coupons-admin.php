            ...
            <div class="panel panel-default">
                <div class="panel-heading" role="tab" id="headingOne">
                    <div class="panel-title">
                        <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#coupon-accordion" data-target="#em-event-bookings-coupons" aria-expanded="true" aria-controls="em-event-bookings-coupons">
        <?php _e('Coupons', 'em-pro'); ?>
                        </a>
                    </div>
                </div>
                <div id="em-event-bookings-coupons" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                ...
                <?php echo '<strong>' . esc_html($EM_Coupon->coupon_code) . '</strong> - ' . esc_html($EM_Coupon->get_discount_text()); ?><br />
                                    <em><?php echo esc_html($EM_Coupon->coupon_name);
                if (!empty($EM_Coupon->coupon_description)) echo esc_html(' - ' . $EM_Coupon->coupon_description); ?></em>
                                </p>
            <?php endforeach; ?>
        <?php endif; if($no_msg) _e('No coupons created yet.', 'em-pro');  ?>
                    </div>
                </div>
            </div>
        </div>
