...
class EM_Gateway {
	...
	function booking_form_button(){
		...
		if( preg_match('/https?:\/\//',get_option('em_'. $this->gateway . "_button")) ): ?>
			<input type="image" class="em-booking-submit em-gateway-button btn btn-primary" id="em-gateway-button-<?php echo $this->gateway; ?>" src="<?php echo get_option('em_'. $this->gateway . "_button"); ?>" alt="<?php echo $this->title; ?>" />
		<?php else: ?>
			<input type="submit" class="em-booking-submit em-gateway-button btn btn-primary" id="em-gateway-button-<?php echo $this->gateway; ?>" value="<?php echo get_option('em_'. $this->gateway . "_button",$this->title); ?>" />
		<?php endif;
		return ob_get_clean();
	}
