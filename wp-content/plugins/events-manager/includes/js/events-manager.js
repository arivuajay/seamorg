...
//    }
    ...
    $(document).delegate('.em-search-form, .em-events-search-form', 'submit', function(e) {
        ...
        if (results_wrapper.length > 0) {
            ...
            if (img.length > 0)
                img.attr('src', img.attr('src').replace('search-mag.png', 'search-loading.gif'));
            ...
            $.ajax(EM.ajaxurl, {
                ...
                success: function(responseText) {
                    ...
                    if (img.length > 0)
                        img.attr('src', img.attr('src').replace('search-loading.gif', 'search-mag.png'));
    ...
    if ($("#em-tickets-form").length > 0) {
        ...
        $('.em-ticket-form').each(function() {
            ...
            if (show_advanced)
                el.find('.ticket-options-advanced').trigger('click');
        });
        //Delete a ticket
