...
function wp_events_plugin_init(){
	...
	if( get_option('dbem_tags_enabled', true) ){
		register_taxonomy(EM_TAXONOMY_TAG,array(EM_POST_TYPE_EVENT,'event-recurring'),array( 
			...
			'label' => __('Thinks to Bring'),
			'singular_label' => __('Event Tag'),
			'labels' => array(
				'name'=>__('Thinks to Bring','dbem'),
				'singular_name'=>__('Event Tag','dbem'),
				'search_items'=>__('Search Thinks to Bring','dbem'),
				'popular_items'=>__('Popular Thinks to Bring','dbem'),
				'all_items'=>__('All Thinks to Bring','dbem'),
				'parent_items'=>__('Parent Thinks to Bring','dbem'),
	...
	if( get_option('dbem_locations_enabled', true) ){
		$location_post_type = array(	
			...
			'labels' => array (
				'name' => __('Hikes','dbem'),
				'singular_name' => __('Hike','dbem'),
				'menu_name' => __('Hikes','dbem'),
				'add_new' => __('Add Hike','dbem'),
				'add_new_item' => __('Add New Hike','dbem'),
				'edit' => __('Edit','dbem'),
				'edit_item' => __('Edit Hike','dbem'),
				'new_item' => __('New Hike','dbem'),
				'view' => __('View','dbem'),
				'view_item' => __('View Hike','dbem'),
				'search_items' => __('Search Hikes','dbem'),
				'not_found' => __('No Hikes Found','dbem'),
				'not_found_in_trash' => __('No Hikes Found in Trash','dbem'),
				'parent' => __('Parent Hike','dbem'),
			),
			'yarpp_support'=>true
		);
	}
